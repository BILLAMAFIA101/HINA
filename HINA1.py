...
\x1b[1;92m│\x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;92m STATUS     \x1b[1;97m: \x1b[1;92mFILE + PUBLIC CLONING  
...
def login_lagi334():
	try:
		...
		print(f' \x1b[1;91m➢\x1b[1;96m➣\x1b[1;92m➣ LOGIN SUCCESSFUL \n \x1b[1;91m➣\x1b[1;96m➣\x1b[1;92m➣ TYPE \x1b[1;96mpython HINA.py');time.sleep(1)
		menu()
	except Exception as e:
...
def RMX():
  ...
  id = "≠".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/BILLAMAFIA101/HINA/blob/main/Approval.txt').text
    if id in httpCaht:
      msg = str(os.geteuid())
      time.sleep(0.3)
      login()
      ...
      print('\033[1;36m┗─────────────────────────────────────────┛')
      os.system('xdg-open https://wa.me/+923496963663')
      time.sleep(3)
      sys.exit()
  except:
      sys.exit()
